class ChatbotJob < ApplicationJob
  ...
  def questions_formatted_for_openai
    ...
    questions.each do |question|
      results << { role: "user", content: question.user_question + "only responds if this is related to the fashion industry otherwise respond with 'I'm sorry, I can only answer questions related to the fashion industry. Please try again.'"}
